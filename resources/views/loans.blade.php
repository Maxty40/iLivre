        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-xl overflow-hidden">
                <div class="px-6 py-5 border-b border-slate-100 flex items-center gap-3">
                    ...
                    <span
                        class="ml-auto text-sm font-semibold bg-orange-100 text-orange-700 px-3 py-1 rounded-full">{{ $activeLoans->count() }}
                        buku</span>
                </div>
                                ...
                                @foreach ($activeLoans as $loan)
                                    ...
                                    <tr x-data="{ open: false }" class="hover:bg-slate-50 transition">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @else
                                                <span
                                                    class="inline-flex text-xs font-semibold text-green-700 bg-green-100 px-2.5 py-1 rounded-full">Aktif</span>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 text-right">
                                            ...
                                            <div x-show="open" x-cloak
                                                ...
                                                <div @click.outside="open = false"
                                                    ...
                                                    <p class="text-slate-600 mb-2">Apakah Anda yakin ingin mengembalikan
                                                        buku:</p>
                            ...
                            <tbody class="bg-white divide-y divide-slate-100">
                                @foreach ($returnHistory as $item)
                                    <tr class="hover:bg-slate-50 transition">
                                        ...
                                        <td class="px-6 py-4 text-sm text-slate-500">
                                            {{ \Carbon\Carbon::parse($item->loan_date)->format('d M Y') }}</td>
                                        <td class="px-6 py-4 text-sm text-slate-500">
